<template>
  <div class="w-full bg-kq-black-200 rounded-t-md rounded-b-2xl pt-6 pb-12">
    <h2 class="text-3xl font-bold mb-4 flex items-center gap-2 px-2">
      <Icon name="lets-icons:world-2" class="text-kq-white !h-8 !w-8" />
      Global
    </h2>
...
const loadHighScores = async () => {
  ...
  try {
    highScores.value = await getCombinedHighScores(10);
  } catch (err: any) {
